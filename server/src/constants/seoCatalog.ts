...
export const DEFAULT_SEO_PACKAGES: SeoPackageSeed[] = [
  {
    ...
    guaranteeMonths: 12,
    contentPieces: [
      { qty: 4, label: "News promo article" },
      { qty: 2, label: "Elite promo article" },
    ],
    backlinkProfile: p(
  ...
  },
  {
    ...
    contentPieces: [
      ...
      { qty: 1, label: "Buffer blog promo article" },
      { qty: 1, label: "Buffer blog promo article 2" },
    ],
    backlinkProfile: p(
  ...
  },
  {
    ...
    contentPieces: [
      ...
      { qty: 10, label: "Forum promo article" },
      { qty: 1, label: "Buffer blog promo article" },
      { qty: 1, label: "Buffer blog promo article 2" },
    ],
    backlinkProfile: p(
  ...
  {
    name: "Apex",
    positioning: "Highest competition — our flagship authority backlink package",
    sortOrder: 4,
    price: 1190,
    currency: "EUR",
    features: [
