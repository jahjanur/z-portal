...
router.post("/:id/payments", verifyJWT, uploadInvoice.single("receipt"), async (req: any, res) => {
  try {
...
router.patch("/:id/payments/:paymentId", verifyJWT, uploadInvoice.single("receipt"), async (req: any, res) => {
  try {
